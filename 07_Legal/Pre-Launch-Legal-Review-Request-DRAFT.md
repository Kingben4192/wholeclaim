...
The six questions below require an attorney licensed in Georgia. They are separate from the trademark clearance question referenced above, which is being handled by counsel licensed in Indiana/Texas — please do not route these to that attorney.
...
5. **Does calculating legal, appeal, or answer deadlines create UPL concerns?**
   New topic (Decision #100). Safe boundary being checked: user-managed reminders and organization vs. legal deadline computation.
6. **Does AI identifying "documents that weaken your file" constitute legal strategy advice?**
   New topic (Decision #100). Safe boundary being checked: missing-document detection and organization completeness vs. legal evaluation.

> **Dormant item — Decision #100:** docket-triggered outreach (mining public
> court dockets/administrative records to identify and market to people in
> property disputes) raised solicitation/referral-structure concerns
> requiring counsel review before any future reconsideration. Rejected as
> a lead-generation channel; the companion Dispute Readiness Score and
> opt-in docket-monitoring concept is parked, not built. Revisit only if
> the docket-monitoring concept is reopened.
