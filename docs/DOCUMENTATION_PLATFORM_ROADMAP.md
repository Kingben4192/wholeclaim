...
|---|---|---|---|
| **Learn** | Educational content — failure patterns, research findings, plain-English explanation | ✅ Live for Government (v0.2 site); Nonprofit/Business framed honestly as research-stage, no content yet | Nonprofit/Business: requires the org-type replication research (parked, gated on Federal Audit Clearinghouse corpus actually being mined) |
